...
module.exports = {
  ...
  run: async (bot, message, args) => {
    ...
    if(!serverRegion) return message.channel.send("Please provide a region! or use", `billi svr ${availableRegions}`);
    ...
    if(availableRegions.includes(serverRegion)) {
      ...
      return message.channel.send("Please provide a valid region ID! Please use ", `billi svr ${availableRegions}`)
    }
